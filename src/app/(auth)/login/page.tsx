...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-tabarka-blue-50 dark:bg-gray-900 flex items-center justify-center px-4">
      <motion.div 
      ...
      >
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Sign in to continue your Tabarka adventure</p>
          </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link
                  ...
                  className="text-sm text-tabarka-blue-600 dark:text-tabarka-blue-400 hover:text-tabarka-blue-800 dark:hover:text-tabarka-blue-300 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
